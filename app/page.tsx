...
const NewsCycle = () => {
    ...
    const newPage = () => {
      ...
      const urls = [
        ...
        ["Daily Maverick (South Africa)", "https://www.dailymaverick.co.za/"],
        ...
        ["Yomiuri Shimbun", "https://www.yomiuri.co.jp/english/"],
        ...
        ["ABC News - Politics", "https://abcnews.go.com/politics"],
